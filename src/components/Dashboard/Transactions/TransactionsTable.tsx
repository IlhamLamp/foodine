...
const TransactionsTable = forwardRef<HTMLTableElement, TransactionTableProps>(({ id, orders, page, prevPage, perPage, popup}, ref) => {
    ...
    return (
        <table id={id} ref={ref} className="w-full text-sm text-left text-gray-500">
